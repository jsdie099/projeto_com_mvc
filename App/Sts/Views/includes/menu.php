    ...
    <div class="container-fluid">
        <nav class="navbar-fixed-top navbar-inverse">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=ucfirst($this->title[2]);?>"><img src="assets/imagens/logo.jpg" style="height: 60px; width: 60px; margin-left: 50px;" alt=""></a><!--Título do site. O destino deste link deve ser a home-page do site.
                 Se em lugar do título do site você decidir por colocar uma pequena imagem (20px x 20px) do logotipo ou marca
                 do site substitua o texto do link por um elemento img com o endereço do logotipo-->
            </div>
